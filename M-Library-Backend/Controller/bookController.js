...
//   try { 
// const book = new BookM(req.body)
// await book.save()
// res.status(200).json({ msg:'A new book has been Created',book:book});
//   } catch (error) {
...
module.exports = {createbook,seebook,idgetbook,updatebook,deletebook,byisbn};